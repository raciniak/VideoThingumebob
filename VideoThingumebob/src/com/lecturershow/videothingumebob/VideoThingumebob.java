...
public class VideoThingumebob {
     ...
     * @param tolleranceOfDifference poziom tolerancji na zmianę koloru (0 -
     * 255)
     * @param intervalTime czas w sekundach z jaką ma odbywać się porównywanie
     * obrazów
     * @param ommitedPixelPercent Wartość procentowa, która określa ile procent
     * pikseli całego obrazu może zostać pominięta, kiedy nie są identyczne
     * podczas porównywania
     * @param backBufferSize nazwałem to buforem powrotnym, to ilość obrazów,
     * które będą porównywane z aktualnym, w celu wyeliminowania animowanego
     * przejścia między slajdami
     * @throws BadFileLocationException Wyjątek rzucany, kiedy lokalizacja pliku
     * jest niepoprawna
     * @throws BadDirectoryLocationException Wyjątek rzucany, kiedy likalizacja
     * katalogu jest niepoprawna
     * @throws BadTypeFileException Wyjątek rzucany, kiedy rozszerzenie pliku
    ...
    public void showStats() {
         ...
         * tells you what's inside the container.
         *
    ...
    public void saveVideoDuration() {
        PrintWriter out;
        try {
            out = new PrintWriter(this.picsSaveLocation + "timesMovie.txt");

            out.println("0");
            out.println((int)(this.videoDuration/1000000));
    ...
    /**
     * Funkcja realizująca główną ideę naszego modełka, czyli wyłapywanie
     * slajdów z pliku video podanego jako parametr konstruktora.
     */
    ...
    /**
     * Funkcja wyciąga z pliku wideo miniaturki metodą losową i zapisuje je w
     * katalogu output/snapshots/ video podanego jako parametr konstruktora.
     */
